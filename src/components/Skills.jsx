...
const Skills = () => {
  return (
    <div className='pl-8 pr-8 md:pt-10 pt-6' id='Skills'>
        ...
        <div>
      <div className='grid grid-cols-3 gap-4 gap-y-4 md:gap-10 md:gap-y-10 md:text-4xl hover:shadow-orange-400 '>
       
       <div className='rounded-md shadow-md w-auto h-50  hover:shadow-orange-400 '>
      ...
      <div className='rounded-md shadow-md w-auto h- hover:shadow-orange-400 '>
      ...
      <div className='rounded-md shadow-md w-auto h-auto hover:shadow-orange-400 '>
